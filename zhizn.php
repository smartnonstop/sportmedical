...
$zhizni = $db->getZhizni($type,$page);
$pages_result = $db->pagesResultZhizn($type);
$pages = ceil($pages_result/20);
$name_zhizni = $db->getNameZhiznByType($type);
...
<head>
    ...
    <script type="text/javascript" src="http://img.webmd.com/dtmcms/live/webmd/PageBuilder_Assets/JS/oas71.js"></script>-->
        ...
        <link rel="stylesheet" href="css/fourforclinics.css"/>
            ...
            <div class="masthead-scrollbar">
                <div class="masthead-scrollbar-inner">
                    <div class="masthead-scrollbar-logo">
                        <a href="http://www.webmd.com" class="masthead-scrollbar-logo-link" data-metrics-link="logo">
                            <img src="img/sportmedical.png" class="navigation-globalnav-logo"
                                 alt="Sportmedical: Лучшая информация для вашего здоровья"
                                 title="Sportmedical: Лучшая информация для вашего здоровья">
                        </a>
                    </div>
        ...
        <section id="s2" class="section">
            <div id="ContentPane12" class="pane">
                ...
                <div class="topStories module" id="head-hp">
                    <div class="module-header clearfix" style="margin-bottom:20px;">
                        <h2 style="color:black;"><?= $name_zhizni['nazva'];?></h2>
                       
                    </div>
                    <div style="margin:0px 50px;">
                        <div class="mainStory clearfix" style="padding-bottom:20px;">

                                <?php $u=($page-1)*20;?>
                                <?php foreach($zhizni as $zhizn):?>

                                    <?=++$u;?>. <a href="zhizndetail.php?n=<?=$zhizn->getId();?>&type=<?=$type?>" style="margin-top:10px;display:inline;"><?= $zhizn->getNazva();?></a>
                                    <p><?=$zhizn->getDescription();?></p><br>
                                <?php endforeach;?>
                        ...
                        <div style="border-top: 1px dashed grey;padding:10px;">
                            <?php if($page!=1):?>
                                <a href="zhizn.php?p=<?=$page-1;?>&type=<?=$type;?>">назад</a>
                            <?php endif;?>
                            <?=$page;?> из <?=$pages;?>
                            <?php if($page!=$pages):?>
                                <a href="zhizn.php?p=<?=$page+1;?>&type=<?=$type;?>">вперед</a>
                            <?php endif;?>
                        </div>
                    </div>
                </div>
