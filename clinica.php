...
$name_clinica = $db->getNameClinicsById($clinica->getIdKind());
    ...
    <div id="chrome" class="chrome">
        <section id="s2" class="section">
            <div id="ContentPane12" class="pane">
                <div class="heroWithCaption module" id="prm-hp" style="padding:20px;">
                    <div>
                        <a href="clinics.php?type=<?=$type;?>" style="display:inline;"><?=$name_clinica['nazva']?></a> / <?=$clinica->getNazva()?>
                    </div>
                    
                    <div style="margin:20px 5px;">
                        <h2 style="color:black;"><?=$clinica->getNazva()?></h2>
                    </div>
            
                        <img src="<?=$clinica->getImage()?>" style="width:200px;">
                        <div style="margin:15px 0px;">

                            <p>Тел: <?=$clinica->getPhone()?></p>
                            <p>Адрес: <?=$clinica->getAdress()?></p>
                            <a href="http://<?=$clinica->getWebsite()?>"><?=$clinica->getWebsite()?></a>
                        </div>
                        ...
                        <div class="tabs">
                            ...
                            <div>
                                <?=$clinica->getText();?>
                                <div>
                                    Первое содержимое Первое содержимое Первое содержимое
                                    Первое содержимое Первое содержимое 
                                    Первое содержимое Первое содержимое Первое содержимое 
                                    Первое содержимое Первое содержимое
                                    Первое содержимое Первое содержимое Первое содержимое 
                                    Первое содержимое Первое содержимое
                                ...
                                <div>
                                    Второе содержимое Второе содержимое Второе содержимое
                                    Второе содержимое Второе содержимое Второе содержимое
                                    Второе содержимое Второе содержимое Второе содержимое
                                    Второе содержимое Второе содержимое Второе содержимое
                                </div>
                                <div>
                                    Третье содержимое Третье содержимое Третье содержимое
                                    Третье содержимое Третье содержимое Третье содержимое
                                    Третье содержимое Третье содержимое Третье содержимое
                                </div>
                                <div>
                                    <div>
                                        <a href="img/clinics/clinics/1.jpg" rel="gallery" class="fancybox" style="display:inline-block;">
                                            <img src="img/clinics/clinics/1.jpg" class="pimg" style="height:100px;">
                                        </a>
                                        <a href="img/clinics/clinics/1.jpg" rel="gallery" class="fancybox" style="display:inline-block;">
                                            <img src="img/clinics/clinics/1.jpg" class="pimg" style="height:100px;">
                                        </a>
                                ...
                                <div>
                                    Четвертое содержимое Четвертое содержимое Четвертое содержимое
                                    Четвертое содержимое Четвертое содержимое Четвертое содержимое
                                    Четвертое содержимое Четвертое содержимое Четвертое содержимое
                                </div>
                            </div>            
