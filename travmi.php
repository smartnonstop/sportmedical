...
$travmi = $db->getTravmi($type,$page);
$pages_result = $db->pagesResultTravmi($type);
$pages = ceil($pages_result/20);
$name_travmi = $db->getNameTravmiByType($type);
            ...
            <div id="ContentPane12" class="pane">
                ...
                <div class="topStories module" id="head-hp">
                    <div class="module-header clearfix" style="margin-bottom:20px;">
                        <h2 style="color:black;"><?= $name_travmi['nazva'];?></h2>
                    ...
                    <div style="margin:0px 50px;">
                        <div class="mainStory clearfix" style="padding-bottom:20px;">
                            <ul style="list-style-type:circle;">
                                ...
                                <li><a href="travma.php?n=<?=$travma->getId();?>&type=<?=$type?>" style="margin-top:10px;display:inline;"><?= $travma->getNazva();?></a></li>
                                <?php endforeach;?>
                            </ul>
                        </div>
                        ...
                        <div style="border-top: 1px dashed grey;padding:10px;">
                            <?php if($page!=1):?>
                                <a href="travmi.php?p=<?=$page-1;?>&type=<?=$type;?>">назад</a>
                            <?php endif;?>
                            <?=$page;?> из <?=$pages;?>
                            <?php if($page!=$pages):?>
                                <a href="travmi.php?p=<?=$page+1;?>&type=<?=$type;?>">вперед</a>
                            <?php endif;?>
                        </div>
                    </div>
                </div>
