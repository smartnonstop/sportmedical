...
$semyas = $db->getSemyas($type,$page);
$pages_result = $db->pagesResultSemya($type);
$pages = ceil($pages_result/20);
$name_semya = $db->getNameSemyaByType($type);
            ...
            <div id="ContentPane12" class="pane">
                ...
                <div class="topStories module" id="head-hp">
                    <div class="module-header clearfix" style="margin-bottom:20px;">
                        <h2 style="color:black;"><?= $name_semya['nazva'];?></h2>
                    ...
                    <div style="margin:0px 50px;">
                        <div class="mainStory clearfix" style="padding-bottom:20px;">
                             ...
                             <?php $u=($page-1)*20;?>
                                <?php foreach($semyas as $semya):?>
                                    <?=++$u;?>. <a href="semyadetail.php?n=<?=$semya->getId();?>&type=<?=$type?>" style="margin-top:10px;display:inline;"><?= $semya->getNazva();?></a>
                                    <p><?=$semya->getDescription();?></p><br>
                                <?php endforeach;?>
                        ...
                        <div style="border-top: 1px dashed grey;padding:10px;">
                            <?php if($page!=1):?>
                                <a href="semya.php?p=<?=$page-1;?>&type=<?=$type;?>">назад</a>
                            <?php endif;?>
                            <?=$page;?> из <?=$pages;?>
                            <?php if($page!=$pages):?>
                                <a href="semya.php?p=<?=$page+1;?>&type=<?=$type;?>">вперед</a>
                            <?php endif;?>
                        </div>
                    </div>
                </div>
