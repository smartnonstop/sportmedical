...
$name_zhizn = $db->getNameZhiznByType($type);
        ...
        <section id="s2" class="section">
            <div id="ContentPane12" class="pane">
                <div class="heroWithCaption module" id="prm-hp" data-metrics-module="prm-hp" style="padding:20px;">
                    <div>
                        <a href="zhizn.php?type=<?=$type;?>" style="display:inline;"><?=$name_zhizn['nazva']?></a> / <?=$zhizn->getNazva()?>
                    </div>
                    
                    <div style="margin:20px 5px;">
                        <h2 style="color:black;"><?=$zhizn->getNazva()?></h2>
                    </div>
