...
$clinics = $db->getClinics($type,$page);
$pages_result = $db->pagesResultClinica($type);
$pages = ceil($pages_result/12);
$name_clinics = $db->getNameClinicsByType($type);
        ...
        <section id="s2" class="section">
            <div id="ContentPane12" class="pane">
                ...
                <div class="topStories module" id="head-hp" data-metrics-module="head-hp">
                        ...
                        <h1 style="margin:20px 20px;color:black;"><?= $name_clinics['nazva'];?></h1>
                       
                    
                    <div class="module-content">
                        <?foreach($clinics as $clinica):?>
                        <div class="mainStory clearfix" style="border-bottom: 1px dashed grey;padding:10px;">
                            <a href="clinica.php?n=<?=$clinica->getId();?>&type=<?=$type;?>">
                                <div class="image-asset">
                                    <img style="width:200px;" src="<?=$clinica->getImage();?>">
                                </div>
                            </a>
                            
                                <div>
                                   <a href="clinica.php?n=<?=$clinica->getId();?>&type=<?=$type;?>"><h3><?=$clinica->getNazva();?></h3></a>
                        ...
                        <div style="padding:10px;">
                            <?php if($page!=1):?>
                                <a href="clinics.php?p=<?=$page-1;?>&type=<?=$type;?>">назад</a>
                            <?php endif;?>
                            <?=$page;?> из <?=$pages;?>
                            <?php if($page!=$pages):?>
                                <a href="clinics.php?p=<?=$page+1;?>&type=<?=$type;?>">вперед</a>
                            <?php endif;?>
                        </div>
                    </div>
                </div>
