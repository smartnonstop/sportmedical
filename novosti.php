            ...
            <div id="ContentPane12" class="pane">
                ...
                <div class="topStories module" id="head-hp">
                    <div class="module-header clearfix">
                        <h2><?= $name_news['nazva'];?></h2>
                       
                    </div>
                    <div class="module-content">
                        <?php if($page==1):?>
                        <div class="mainStory clearfix">
                            <a href="novost.php?type=<?=$type;?>&n=<?=$news[0]->getId();?>">
                        ...
                        <ul class="subfeature">
                            <li>
                                <a href="novost.php?type=<?=$type;?>&n=<?=$news[$i]->getId();?>">
                                    <div class="image-asset">
                ...
                <div style="text-align:center;">
                    <?php if($page!=1):?>
                        <a href="novosti.php?p=<?=$page-1;?>&type=<?=$type;?>">назад</a>
                    <?php endif;?>
                    <?=$page;?> из <?=$pages;?>
                    <?php if($page!=$pages):?>
                        <a href="novosti.php?p=<?=$page+1;?>&type=<?=$type;?>">вперед</a>
                    <?php endif;?>
                </div>
            </div>
