...
$name_new = $db->getNameNewsByType($type);
    ...
    <div id="chrome" class="chrome">
        <section id="s2" class="section">
            <div id="ContentPane12" class="pane">
                <div class="heroWithCaption module" id="prm-hp" data-metrics-module="prm-hp">
                    <div style="padding:10px;">
                        <a href="novosti.php?type=<?=$type;?>" style="display:inline;"><?=$name_new['nazva']?></a> / <?=$new->getNazva()?>
                    </div>
                    <div style="padding:10px;">
                        <img src="img/sportnews/1.jpg" style="width:90%;">
                        <div class="caption">
                            <h2><?=$new->getNazva()?></h2>
                            <p></p>
                        </div>
                    ...
                    <ul>
                        <li>
                            <a href="#" style="font-size:30px; color:#003399;">
                                <i class="fa fa-facebook-square"></i>
                            </a>
                            <a href="#" style="font-size:30px;">
                                <i class="fa fa-twitter-square"></i>
                            </a>
                            <a href="#" style="font-size:30px; color:#D80000;">
                                <i class="fa fa-google-plus-square"></i>
                            </a>
                        </li>
                        <!--<li>
                            <a href="http://blogs.webmd.com/breaking-news/2016/02/survey-reveals-beliefs-behaviors-on-alzheimers.html" data-metrics-link="more-2"> Survey: Are You Prepared for Alzheimer's?</a>
                        </li>-->
                    </ul>
                </div>
