    ...
    <div id="chrome" class="chrome">
        <section id="s2" class="section">
            ...
            <div id="ContentPane12" class="pane">
                <div class="heroWithCaption module" id="prm-hp" style="padding:10px;">
                    <!--<a href="index2.php">
                        <img src="img/sportnews/1.jpg" style="width:600px;">
                        <div class="caption">
                            <h2>WADA перепроверит допинг-пробы c Олимпиады в Сочи</h2>
                            <p></p>
                        </div>
                    </a>-->
                    <?php require_once "jssor.php";?>
                    
                </div>
                <div class="topStories module" id="head-hp" data-metrics-module="head-hp">
                    <div class="module-header clearfix">
                        <h2>Новости</h2>
                        <a href="novostiall.php" data-metrics-link="1-all">Больше</a>
                    </div>
                    <div class="module-content">
                        <div class="mainStory clearfix">
                            <a href="http://www.webmd.com/women/news/20160225/cranberry-juice-for-urinary-tract-infection" data-metrics-link="1-1">
                            ...
                            <a href="http://www.webmd.com/women/news/20160225/cranberry-juice-for-urinary-tract-infection" data-metrics-link="1-1">
                                <div class="summary">
                                    <h3>Does Cranberry Juice Help UTIs?</h3>
                                    <p></p>
                                </div>
                            </a>
                        </div>
                        <ul class="subfeature">
                            <li>
                                <a href="http://www.webmd.com/a-to-z-guides/zika-virus-symptoms-prevention" data-metrics-link="1-2">
                                    <div class="image-asset">
                                        <img src="img/sportnews/1.jpg">
                                    </div>
                                    <h3>What You Should Know About the Zika Virus</h3>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.webmd.com/health-insurance/20160129/presidential-candidates-abortion-obamacare" data-metrics-link="1-3">
                                    <div class="image-asset">
                                        <img src="img/sportnews/1.jpg">
                                    </div>
                                    <h3>Where Candidates Stand on Health Issues</h3>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.webmd.com/healthy-aging/news/20160301/scientists-report-finding-gray-hair-gene" data-metrics-link="1-4">
                                    <div class="image-asset">
                                        <img src="img/sportnews/1.jpg">
                                    </div>
                                    <h3>Scientists May Have Found the Gray Hair Gene</h3>
                                </a>
                            </li>
                        </ul>
                        <ul class="text-links">
                            <li>
                                <a href="http://www.webmd.com/news/20160226/pregnant-travelers-zika-tests" data-metrics-link="1-5">
                                    <h3>Pregnant Travelers, Tough Choices on Zika Testing</h3>
                                    <p></p>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.webmd.com/mental-health/addiction/news/20160226/pot-habit-early-in-life-may-alter-brain-study-suggests" data-metrics-link="1-6">
                                    <h3>Pot Habit in Youth May Alter Brain</h3>
                                    <p></p>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.webmd.com/sexual-conditions/news/20160229/female-libido-pill-may-not-be-worth-it-researchers" data-metrics-link="1-7">
                                    <h3>Female Libido Pill May Not Be Worth It</h3>
                                    <p></p>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.webmd.com/beauty/treatments/20160226/more-americans-opting-for-butt-implants-lifts" data-metrics-link="1-8">
                                    <h3>More Americans Getting These Implants</h3>
                                    <p></p>
                                </a>
                            </li>
                            <li>
                                <a href="http://www.webmd.com/diet/obesity/20160219/researchers-pursue-clue-between-obesity-breast-and-pancreatic-cancer" data-metrics-link="1-9">
                                    <h3>Weight May Be Linked to Pancreatic and Breast Cancers</h3>
                                    <p></p>
                                </a>
                            </li>
                            <li>
                                <a href="http://teens.webmd.com/news/20160229/young-athletes-pressured-by-parents-may-resort-to-doping" data-metrics-link="1-10">
                                    <h3>Parental Pressure May Push Young Athletes to 'Doping'</h3>
                                    <p></p>
                                </a>
                            </li>
                        </ul>
        ...
        <div id="ContentPane64" class="pane">
            <footer>
                <div class="footerContent">
                    <div class="logo">
                                <a href="index.php" title="Sportmedical"><img src="img/sportmedical.png" alt="Sportmedical Logo" /></a>
